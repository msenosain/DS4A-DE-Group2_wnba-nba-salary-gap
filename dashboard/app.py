...
app.layout = html.Div(
    [
        html.Div(
            [
                html.H1(children="WNBA/NBA Salary gap"),
                html.Label(
                    "After over half a century since the Equal Pay Act was passed in the US women still face issues of gender pay gap across various job spectrums today. The WNBA, especially in recent years, have  been vocal about the unfair compensation compared to their male counterparts. Their advocacy for equal pay is not a cry for these women athletes to necessarily earn the same as their male counterparts but more importantly for fair compensation based on generated revenue and shared ratios. ",
